...
const routes = [
    ...
    {
        path: 'asso-register',
        loadChildren: () => __webpack_require__.e(/*! import() | asso-register-asso-register-module */ "asso-register-asso-register-module").then(__webpack_require__.bind(null, /*! ./asso-register/asso-register.module */ "./src/app/asso-register/asso-register.module.ts")).then(m => m.AssoRegisterPageModule)
    },
    {
        path: 'croplogo',
        loadChildren: () => __webpack_require__.e(/*! import() | croplogo-croplogo-module */ "croplogo-croplogo-module").then(__webpack_require__.bind(null, /*! ./croplogo/croplogo.module */ "./src/app/croplogo/croplogo.module.ts")).then(m => m.CroplogoPageModule)
    },
    {
        path: 'asso-edit-profile',
        loadChildren: () => __webpack_require__.e(/*! import() | asso-edit-profile-asso-edit-profile-module */ "asso-edit-profile-asso-edit-profile-module").then(__webpack_require__.bind(null, /*! ./asso-edit-profile/asso-edit-profile.module */ "./src/app/asso-edit-profile/asso-edit-profile.module.ts")).then(m => m.AssoEditProfilePageModule)
    },
    {
        path: 'asso-login',
        loadChildren: () => __webpack_require__.e(/*! import() | asso-login-asso-login-module */ "asso-login-asso-login-module").then(__webpack_require__.bind(null, /*! ./asso-login/asso-login.module */ "./src/app/asso-login/asso-login.module.ts")).then(m => m.AssoLoginPageModule)
    },
    {
        path: 'croplogoedit',
        loadChildren: () => __webpack_require__.e(/*! import() | croplogoedit-croplogoedit-module */ "croplogoedit-croplogoedit-module").then(__webpack_require__.bind(null, /*! ./croplogoedit/croplogoedit.module */ "./src/app/croplogoedit/croplogoedit.module.ts")).then(m => m.CroplogoeditPageModule)
    },
    {
        path: 'calendar',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | asso-post-event-asso-post-event-module */ "asso-post-event-asso-post-event-module").then(__webpack_require__.bind(null, /*! ./asso-post-event/asso-post-event.module */ "./src/app/asso-post-event/asso-post-event.module.ts")).then(m => m.AssoPostEventPageModule)
    }
];
