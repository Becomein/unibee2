...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["start-start-module"], {
  ...
  function srcAppStartStartPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StartPage = /*#__PURE__*/function () {
      function StartPage(router, route, afAuth, firestore, user) {
      ...
      _createClass(StartPage, [{
        ...
        value: function checkUser() {
          ...
          var docRef = this.firestore.collection('privatebene').doc(this.user.getUID());
          docRef.get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (doc) {
            return doc.data();
          })).subscribe(function (data) {
            if (data) {
              console.log('bene');

              _this.router.navigate(['bene-tabs/bene-list']);
            } else {
              console.log('asso');
    ...
    StartPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
      selector: 'app-start',
